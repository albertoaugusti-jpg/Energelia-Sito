...
<p class="sottotitolo">{{ cliente.codice or 'Il codice viene assegnato al salvataggio.' }}</p>
<form method="post">
...
def nuovo_cliente_form():
    return rendi("cliente_form", titolo="Nuovo cliente", pagina="clienti", cliente=Cliente(),
...
def scheda_cliente(cid):
    ...
    if not c:
        abort(404)
    return rendi("cliente", titolo=c.ragione_sociale, pagina="clienti", c=c)
